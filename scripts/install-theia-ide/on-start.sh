...
curl https://raw.githubusercontent.com/mf523/amazon-sagemaker-notebook-instance-lifecycle-config-samples/master/scripts/install-theia-ide/package.json -o ${EC2_HOME}/theia/package.json
nohup yarn &
...
curl https://raw.githubusercontent.com/mf523/amazon-sagemaker-notebook-instance-lifecycle-config-samples/master/scripts/install-theia-ide/launch.json -o ${EC2_HOME}/.theia/launch.json
curl https://raw.githubusercontent.com/mf523/amazon-sagemaker-notebook-instance-lifecycle-config-samples/master/scripts/install-theia-ide/settings.json -o ${EC2_HOME}/.theia/settings.json
